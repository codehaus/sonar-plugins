...
public class ForLoopExpressionsConcernedOnlyWithLoopControlCheckTest {

  @Test
  public void testCheck() {
    setCurrentSourceFile(scanFile("/checks/forLoopExpressionsConcernedOnlyWithLoopControl.c",
        new ForLoopExpressionsConcernedOnlyWithLoopControlCheck()));

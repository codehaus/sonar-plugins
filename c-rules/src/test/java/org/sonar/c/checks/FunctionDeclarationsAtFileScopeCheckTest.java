...
public class FunctionDeclarationsAtFileScopeCheckTest {

  @Test
  public void testCheck() {
    setCurrentSourceFile(scanFile("/checks/functionDeclarationsAtFileScope.c", new FunctionDeclarationsAtFileScopeCheck()));

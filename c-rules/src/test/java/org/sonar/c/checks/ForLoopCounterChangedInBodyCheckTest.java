...
public class ForLoopCounterChangedInBodyCheckTest {

  @Test
  public void testCheck() {
    setCurrentSourceFile(scanFile("/checks/forLoopCounterChangedInBodyCheck.c", new ForLoopCounterChangedInBodyCheck()));

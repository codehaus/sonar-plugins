...
public class LinkFunctionTest {
  ...
  public void init() throws Exception {
    ...
    when(soapClient.createIssue(review, settings, null)).thenReturn(remoteIssue);

    action = new LinkFunction(soapClient);
  }
  ...
  public void shouldExecute() throws Exception {
    ...
    verify(soapClient).createIssue(review, settings, null);
    verify(mutableReview).createComment();
    verify(mutableReview).setProperty(JiraLinkReviewsConstants.REVIEW_DATA_PROPERTY_KEY, "FOO-15");
  }

  @Test
  public void shouldFailExecuteIfRemoteProblem() throws Exception {
    when(soapClient.createIssue(review, settings, null)).thenThrow(new RemoteException("Server Error"));
  ...
  public void testCreateComment() throws Exception {
    ...
    verify(comment).setMarkdownText(anyString());
  }
  ...
  public void testGenerateCommentText() throws Exception {
    ...
    settings.appendProperty(JiraLinkReviewsConstants.SERVER_URL_PROPERTY, "http://my.jira.server");

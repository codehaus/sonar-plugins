...
/**
 * File name filter used to filter generated source files.
 * accept() returns true when a file has not been generated by VisualStudio
 *  
...
public class CsFilenameFilter implements FilenameFilter {
	...
	public boolean accept(File dir, String name) {
		boolean result = new File(dir, name).isDirectory() || 
			...
			&& !GeneratedCodeFilter.INSTANCE.isGenerated(name));
		return result;
	}

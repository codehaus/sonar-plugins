...
public class PhpCodesnifferViolationsXmlParserTest {
  ...
  private void parse(SensorContext context, String xmlPath) throws IOException, URISyntaxException, XMLStreamException {
    ...
    PhpCodesnifferViolationsXmlParser parser = new PhpCodesnifferViolationsXmlParser(project, context, manager, profile);
  ...
  public void shouldParseViolation() throws IOException, URISyntaxException, XMLStreamException {
    ...
    Violation wanted = new Violation(new Rule(PhpCodesnifferViolationsXmlParser.KEY,
        "GN/Commenting/ClassCommentSniff/MISSING_CLASS_COMMENT"), new PhpFile("org/sonar/mvn/BaseSonarMojo.php5"));

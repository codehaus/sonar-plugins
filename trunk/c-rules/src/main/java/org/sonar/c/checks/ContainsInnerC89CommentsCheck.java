...
@Rule(key = "C.ContainsInnerC89Comments", name = "A comment shall not contains the string \"/*\".", priority = Priority.MINOR,
...
public class ContainsInnerC89CommentsCheck extends CCheck {

...
public class JiraLinkReviewAction extends ReviewAction {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(JiraLinkReviewAction.class);
  ...
  public void execute(ReviewContext reviewContext) {
    ...
    try {
      ...
      throw new IllegalStateException("Impossible to create an issue on JIRA: a problem occured with the remote server.", e);
    }

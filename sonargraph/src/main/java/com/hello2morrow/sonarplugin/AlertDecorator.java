...
public final class AlertDecorator
{
    ...
    public static void setAlertLevels(IProjectContext context)
    {
        ...
        copyAlertLevel(context, SonargraphMetrics.VIOLATING_TYPES, SonargraphMetrics.ARCHITECTURE_VIOLATIONS);
        copyAlertLevel(context, SonargraphMetrics.VIOLATING_TYPES, SonargraphMetrics.VIOLATING_DEPENDENCIES);
